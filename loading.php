...
function updateTitle() {
  $.ajax({
    url: "https://cors-anywhere.herokuapp.com/https://zenoplay.zenomedia.com/api/zenofm/nowplaying/2cgy8mzvsy8uv",
    type: "GET",
    success: function(data) {
      var musicInfo = JSON.parse(data);
      var title = musicInfo.title;
      $("#title").html("<p>Título da música: " + title + "</p>");
    }
  });
  setTimeout(updateTitle, 60000);
}
</script>
<div id="title"></div>
